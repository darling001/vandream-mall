...
CREATE TABLE `ucm_menu` (
  ...
  `org_id` varchar(40) DEFAULT '0' COMMENT '组织机构ID',
  `book_id` varchar(40) DEFAULT '0' COMMENT '账套ID',
  `group_id` varchar(40) DEFAULT '0' COMMENT '集团ID',
  ...
  `modify_user_id` varchar(40) DEFAULT NULL COMMENT '修改人',
  `modify_user_name` varchar(40) DEFAULT NULL COMMENT '修改人姓名',
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='菜单表';

/*Data for the table `ucm_menu` */
