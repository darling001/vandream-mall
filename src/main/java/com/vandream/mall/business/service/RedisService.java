...
public interface RedisService {
     ...
     * @return
     */
    <T> List<T> getToList(String key, Class<T> c);
     ...
     * @return 值
     */
    <T> T hget(String key, String item, Class<T> c);
     ...
     * @return 值
     */
    <T> List<T> hgetList(String key, String item, Class<T> c);
     ...
     */
    @SuppressWarnings("unchecked")
    <T> List<T> hmvget(String key, Class<T> c);
     ...
     * @return true成功 false失败
     */
    <T> boolean hmset(String key, Map<String, T> map, long time);
     ...
     * @return 对应的多个键值
     */
    <T> Map<String, T> hmget(String key, Class<T> c);
     ...
     */
    @SuppressWarnings("unchecked")
    <T> List<T> lGet(String key, long start, long end, final Class<T> c);
     ...
     */
    @SuppressWarnings("unchecked")
    <T> T lGetIndex(String key, long index, final Class<T> c);
     ...
     * @return
     */
    <T> boolean lSetList(String key, final List<T> list);
     ...
     * @return
     */
    <T> boolean lSetList(String key, final List<T> list, long time);
